...
daeElementRef
intGl_sampler1D::create(daeInt bytes)
{
	intGl_sampler1DRef ref = new(bytes) intGl_sampler1D;
	return ref;
}
...
intGl_sampler1D::registerElement()
{
	...
	_Meta->setStaticPointerAddress(&intGl_sampler1D::_Meta);
	_Meta->registerConstructor(intGl_sampler1D::create);
