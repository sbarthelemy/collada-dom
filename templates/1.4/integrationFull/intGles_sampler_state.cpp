...
intGles_sampler_state::registerElement()
{
	...
	_Meta->setStaticPointerAddress(&intGles_sampler_state::_Meta);
...
intGles_sampler_state::intWrap_s::registerElement()
{
	...
	_Meta->setStaticPointerAddress(&intGles_sampler_state::intWrap_s::_Meta);
...
intGles_sampler_state::intWrap_t::registerElement()
{
	...
	_Meta->setStaticPointerAddress(&intGles_sampler_state::intWrap_t::_Meta);
...
intGles_sampler_state::intMinfilter::registerElement()
{
	...
	_Meta->setStaticPointerAddress(&intGles_sampler_state::intMinfilter::_Meta);
...
intGles_sampler_state::intMagfilter::registerElement()
{
	...
	_Meta->setStaticPointerAddress(&intGles_sampler_state::intMagfilter::_Meta);
...
intGles_sampler_state::intMipfilter::registerElement()
{
	...
	_Meta->setStaticPointerAddress(&intGles_sampler_state::intMipfilter::_Meta);
...
intGles_sampler_state::intMipmap_maxlevel::registerElement()
{
	...
	_Meta->setStaticPointerAddress(&intGles_sampler_state::intMipmap_maxlevel::_Meta);
...
intGles_sampler_state::intMipmap_bias::registerElement()
{
	...
	_Meta->setStaticPointerAddress(&intGles_sampler_state::intMipmap_bias::_Meta);
