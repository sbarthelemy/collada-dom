...
daeMetaElement * intTrifans::intP::_Meta = NULL;
...
daeElementRef
intTrifans::intP::create(daeInt bytes)
{
	intTrifans::intPRef ref = new(bytes) intTrifans::intP;
	return ref;
}
...
intTrifans::intP::registerElement()
{
    ...
    _Meta = new daeMetaElement;
    _Meta->setName( "p" );
	_Meta->setStaticPointerAddress(&intTrifans::intP::_Meta);
	_Meta->registerConstructor(intTrifans::intP::create);

	domTrifans::domP::_Meta->setMetaIntegration(_Meta);

	_Meta->setElementSize(sizeof(intTrifans::intP));
	_Meta->validate();
...
void
intTrifans::intP::createFrom(daeElementRef element)
{
	// INSERT CODE TO CREATE YOUR USER DATA HERE
	// _object = new myRuntimeClass;
}
...
void
intTrifans::intP::fromCOLLADAPostProcess()
{
	// INSERT CODE TO POST PROCESS HERE
	// myRuntimeClassType* local = (myRuntimeClassType*)_object;
	// local->renderingContext = MYGLOBAL::getRenderingContext;
...
void
intTrifans::intP::createTo(void* userData)
{
	// INSERT CODE TO CREATE COLLADA DOM OBJECTS HERE
	// _element = new domGeometry;
	// _object = userData;
...
void
intTrifans::intP::toCOLLADAPostProcess()
{
	// INSERT CODE TO POST PROCESS HERE
	// myRuntimeClassType* local = (myRuntimeClassType*)_object;
	// local->renderingContext = MYGLOBAL::getRenderingContext;
