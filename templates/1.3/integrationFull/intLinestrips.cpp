...
daeMetaElement * intLinestrips::intP::_Meta = NULL;
...
daeElementRef
intLinestrips::intP::create(daeInt bytes)
{
	intLinestrips::intPRef ref = new(bytes) intLinestrips::intP;
	return ref;
}
...
intLinestrips::intP::registerElement()
{
    ...
    _Meta = new daeMetaElement;
    _Meta->setName( "p" );
	_Meta->setStaticPointerAddress(&intLinestrips::intP::_Meta);
	_Meta->registerConstructor(intLinestrips::intP::create);

	domLinestrips::domP::_Meta->setMetaIntegration(_Meta);

	_Meta->setElementSize(sizeof(intLinestrips::intP));
	_Meta->validate();
...
void
intLinestrips::intP::createFrom(daeElementRef element)
{
	// INSERT CODE TO CREATE YOUR USER DATA HERE
	// _object = new myRuntimeClass;
}
...
void
intLinestrips::intP::fromCOLLADA()
{
	// INSERT CODE TO TRANSLATE TO YOUR RUNTIME HERE
	// myRuntimeClassType* local = (myRuntimeClassType*)_object;
	// local->foo = element->foo;
...
void
intLinestrips::intP::fromCOLLADAPostProcess()
{
	// INSERT CODE TO POST PROCESS HERE
	// myRuntimeClassType* local = (myRuntimeClassType*)_object;
	// local->renderingContext = MYGLOBAL::getRenderingContext;
...
void
intLinestrips::intP::createTo(void* userData)
{
	// INSERT CODE TO CREATE COLLADA DOM OBJECTS HERE
	// _element = new domGeometry;
	// _object = userData;
...
void
intLinestrips::intP::toCOLLADAPostProcess()
{
	// INSERT CODE TO POST PROCESS HERE
	// myRuntimeClassType* local = (myRuntimeClassType*)_object;
	// local->renderingContext = MYGLOBAL::getRenderingContext;
