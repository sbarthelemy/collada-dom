...
daeMetaElement * intCombiner::intV::_Meta = NULL;
...
daeElementRef
intCombiner::intV::create(daeInt bytes)
{
	intCombiner::intVRef ref = new(bytes) intCombiner::intV;
	return ref;
}
...
intCombiner::intV::registerElement()
{
    ...
    _Meta = new daeMetaElement;
    _Meta->setName( "v" );
	_Meta->setStaticPointerAddress(&intCombiner::intV::_Meta);
	_Meta->registerConstructor(intCombiner::intV::create);

	domCombiner::domV::_Meta->setMetaIntegration(_Meta);

	_Meta->setElementSize(sizeof(intCombiner::intV));
	_Meta->validate();
...
void
intCombiner::intV::createFrom(daeElementRef element)
{
	// INSERT CODE TO CREATE YOUR USER DATA HERE
	// _object = new myRuntimeClass;
}
...
void
intCombiner::intV::fromCOLLADAPostProcess()
{
	// INSERT CODE TO POST PROCESS HERE
	// myRuntimeClassType* local = (myRuntimeClassType*)_object;
	// local->renderingContext = MYGLOBAL::getRenderingContext;
...
void
intCombiner::intV::createTo(void* userData)
{
	// INSERT CODE TO CREATE COLLADA DOM OBJECTS HERE
	// _element = new domGeometry;
	// _object = userData;
...
void
intCombiner::intV::toCOLLADAPostProcess()
{
	// INSERT CODE TO POST PROCESS HERE
	// myRuntimeClassType* local = (myRuntimeClassType*)_object;
	// local->renderingContext = MYGLOBAL::getRenderingContext;
