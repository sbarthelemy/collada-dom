...
daeMetaElement * intTriangles::intP::_Meta = NULL;
...
daeElementRef
intTriangles::intP::create(daeInt bytes)
{
	intTriangles::intPRef ref = new(bytes) intTriangles::intP;
	return ref;
}
...
intTriangles::intP::registerElement()
{
    ...
    _Meta = new daeMetaElement;
    _Meta->setName( "p" );
	_Meta->setStaticPointerAddress(&intTriangles::intP::_Meta);
	_Meta->registerConstructor(intTriangles::intP::create);

	domTriangles::domP::_Meta->setMetaIntegration(_Meta);

	_Meta->setElementSize(sizeof(intTriangles::intP));
	_Meta->validate();
...
void
intTriangles::intP::createFrom(daeElementRef element)
{
	// INSERT CODE TO CREATE YOUR USER DATA HERE
	// _object = new myRuntimeClass;
}
...
void
intTriangles::intP::fromCOLLADAPostProcess()
{
	// INSERT CODE TO POST PROCESS HERE
	// myRuntimeClassType* local = (myRuntimeClassType*)_object;
	// local->renderingContext = MYGLOBAL::getRenderingContext;
...
void
intTriangles::intP::createTo(void* userData)
{
	// INSERT CODE TO CREATE COLLADA DOM OBJECTS HERE
	// _element = new domGeometry;
	// _object = userData;
...
void
intTriangles::intP::toCOLLADAPostProcess()
{
	// INSERT CODE TO POST PROCESS HERE
	// myRuntimeClassType* local = (myRuntimeClassType*)_object;
	// local->renderingContext = MYGLOBAL::getRenderingContext;
