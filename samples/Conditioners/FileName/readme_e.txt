...
The tool finds all <image> or <include> tags in the input COLLADA data which use a URI with the 
...
If your <image> or <include> tags contain complex URIs, this tool might corrupt them.
