...
DLLSPEC daeString COLLADA_ELEMENT_INPUTGLOBAL = "InputGlobal";
DLLSPEC daeString COLLADA_ELEMENT_INPUTLOCAL = "InputLocal";
DLLSPEC daeString COLLADA_ELEMENT_INPUTLOCALOFFSET = "InputLocalOffset";
DLLSPEC daeString COLLADA_ELEMENT_INSTANCEWITHEXTRA = "InstanceWithExtra";
DLLSPEC daeString COLLADA_ELEMENT_TARGETABLEFLOAT = "TargetableFloat";
DLLSPEC daeString COLLADA_ELEMENT_TARGETABLEFLOAT3 = "TargetableFloat3";
DLLSPEC daeString COLLADA_ELEMENT_FX_SURFACE_FORMAT_HINT_COMMON = "fx_surface_format_hint_common";
...
DLLSPEC daeString COLLADA_ELEMENT_FX_SURFACE_INIT_PLANAR_COMMON = "fx_surface_init_planar_common";
DLLSPEC daeString COLLADA_ELEMENT_ALL = "all";
DLLSPEC daeString COLLADA_ELEMENT_FX_SURFACE_INIT_VOLUME_COMMON = "fx_surface_init_volume_common";
DLLSPEC daeString COLLADA_ELEMENT_PRIMARY = "primary";
DLLSPEC daeString COLLADA_ELEMENT_FX_SURFACE_INIT_CUBE_COMMON = "fx_surface_init_cube_common";
DLLSPEC daeString COLLADA_ELEMENT_ORDER = "order";
DLLSPEC daeString COLLADA_ELEMENT_FACE = "face";
DLLSPEC daeString COLLADA_ELEMENT_FX_SURFACE_INIT_FROM_COMMON = "fx_surface_init_from_common";
DLLSPEC daeString COLLADA_ELEMENT_FX_SURFACE_COMMON = "fx_surface_common";
...
DLLSPEC daeString COLLADA_ELEMENT_FX_SAMPLER1D_COMMON = "fx_sampler1D_common";
...
DLLSPEC daeString COLLADA_ELEMENT_FX_SAMPLER2D_COMMON = "fx_sampler2D_common";
DLLSPEC daeString COLLADA_ELEMENT_WRAP_T = "wrap_t";
DLLSPEC daeString COLLADA_ELEMENT_FX_SAMPLER3D_COMMON = "fx_sampler3D_common";
DLLSPEC daeString COLLADA_ELEMENT_WRAP_P = "wrap_p";
DLLSPEC daeString COLLADA_ELEMENT_FX_SAMPLERCUBE_COMMON = "fx_samplerCUBE_common";
DLLSPEC daeString COLLADA_ELEMENT_FX_SAMPLERRECT_COMMON = "fx_samplerRECT_common";
DLLSPEC daeString COLLADA_ELEMENT_FX_SAMPLERDEPTH_COMMON = "fx_samplerDEPTH_common";
DLLSPEC daeString COLLADA_ELEMENT_FX_COLORTARGET_COMMON = "fx_colortarget_common";
DLLSPEC daeString COLLADA_ELEMENT_FX_DEPTHTARGET_COMMON = "fx_depthtarget_common";
DLLSPEC daeString COLLADA_ELEMENT_FX_STENCILTARGET_COMMON = "fx_stenciltarget_common";
DLLSPEC daeString COLLADA_ELEMENT_FX_CLEARCOLOR_COMMON = "fx_clearcolor_common";
DLLSPEC daeString COLLADA_ELEMENT_FX_CLEARDEPTH_COMMON = "fx_cleardepth_common";
DLLSPEC daeString COLLADA_ELEMENT_FX_CLEARSTENCIL_COMMON = "fx_clearstencil_common";
DLLSPEC daeString COLLADA_ELEMENT_FX_ANNOTATE_COMMON = "fx_annotate_common";
DLLSPEC daeString COLLADA_ELEMENT_FX_INCLUDE_COMMON = "fx_include_common";
DLLSPEC daeString COLLADA_ELEMENT_FX_NEWPARAM_COMMON = "fx_newparam_common";
DLLSPEC daeString COLLADA_ELEMENT_SEMANTIC = "semantic";
DLLSPEC daeString COLLADA_ELEMENT_MODIFIER = "modifier";
DLLSPEC daeString COLLADA_ELEMENT_FX_CODE_PROFILE = "fx_code_profile";
DLLSPEC daeString COLLADA_ELEMENT_GL_SAMPLER1D = "gl_sampler1D";
DLLSPEC daeString COLLADA_ELEMENT_GL_SAMPLER2D = "gl_sampler2D";
DLLSPEC daeString COLLADA_ELEMENT_GL_SAMPLER3D = "gl_sampler3D";
DLLSPEC daeString COLLADA_ELEMENT_GL_SAMPLERCUBE = "gl_samplerCUBE";
DLLSPEC daeString COLLADA_ELEMENT_GL_SAMPLERRECT = "gl_samplerRECT";
DLLSPEC daeString COLLADA_ELEMENT_GL_SAMPLERDEPTH = "gl_samplerDEPTH";
DLLSPEC daeString COLLADA_ELEMENT_GLSL_NEWARRAY_TYPE = "glsl_newarray_type";
DLLSPEC daeString COLLADA_ELEMENT_GLSL_SETARRAY_TYPE = "glsl_setarray_type";
DLLSPEC daeString COLLADA_ELEMENT_GLSL_SURFACE_TYPE = "glsl_surface_type";
DLLSPEC daeString COLLADA_ELEMENT_GENERATOR = "generator";
DLLSPEC daeString COLLADA_ELEMENT_NAME = "name";
DLLSPEC daeString COLLADA_ELEMENT_GLSL_NEWPARAM = "glsl_newparam";
DLLSPEC daeString COLLADA_ELEMENT_GLSL_SETPARAM_SIMPLE = "glsl_setparam_simple";
DLLSPEC daeString COLLADA_ELEMENT_GLSL_SETPARAM = "glsl_setparam";
DLLSPEC daeString COLLADA_ELEMENT_COMMON_FLOAT_OR_PARAM_TYPE = "common_float_or_param_type";
DLLSPEC daeString COLLADA_ELEMENT_FLOAT = "float";
DLLSPEC daeString COLLADA_ELEMENT_PARAM = "param";
DLLSPEC daeString COLLADA_ELEMENT_COMMON_COLOR_OR_TEXTURE_TYPE = "common_color_or_texture_type";
DLLSPEC daeString COLLADA_ELEMENT_COLOR = "color";
DLLSPEC daeString COLLADA_ELEMENT_TEXTURE = "texture";
DLLSPEC daeString COLLADA_ELEMENT_COMMON_TRANSPARENT_TYPE = "common_transparent_type";
DLLSPEC daeString COLLADA_ELEMENT_COMMON_NEWPARAM_TYPE = "common_newparam_type";
...
DLLSPEC daeString COLLADA_ELEMENT_CG_SAMPLER1D = "cg_sampler1D";
DLLSPEC daeString COLLADA_ELEMENT_CG_SAMPLER2D = "cg_sampler2D";
DLLSPEC daeString COLLADA_ELEMENT_CG_SAMPLER3D = "cg_sampler3D";
DLLSPEC daeString COLLADA_ELEMENT_CG_SAMPLERCUBE = "cg_samplerCUBE";
DLLSPEC daeString COLLADA_ELEMENT_CG_SAMPLERRECT = "cg_samplerRECT";
DLLSPEC daeString COLLADA_ELEMENT_CG_SAMPLERDEPTH = "cg_samplerDEPTH";
DLLSPEC daeString COLLADA_ELEMENT_CG_CONNECT_PARAM = "cg_connect_param";
DLLSPEC daeString COLLADA_ELEMENT_CG_NEWARRAY_TYPE = "cg_newarray_type";
DLLSPEC daeString COLLADA_ELEMENT_CG_SETARRAY_TYPE = "cg_setarray_type";
DLLSPEC daeString COLLADA_ELEMENT_CG_SETUSER_TYPE = "cg_setuser_type";
DLLSPEC daeString COLLADA_ELEMENT_CG_SURFACE_TYPE = "cg_surface_type";
DLLSPEC daeString COLLADA_ELEMENT_CG_NEWPARAM = "cg_newparam";
DLLSPEC daeString COLLADA_ELEMENT_CG_SETPARAM_SIMPLE = "cg_setparam_simple";
DLLSPEC daeString COLLADA_ELEMENT_CG_SETPARAM = "cg_setparam";
DLLSPEC daeString COLLADA_ELEMENT_GLES_TEXTURE_CONSTANT_TYPE = "gles_texture_constant_type";
DLLSPEC daeString COLLADA_ELEMENT_GLES_TEXENV_COMMAND_TYPE = "gles_texenv_command_type";
DLLSPEC daeString COLLADA_ELEMENT_GLES_TEXCOMBINER_ARGUMENTRGB_TYPE = "gles_texcombiner_argumentRGB_type";
DLLSPEC daeString COLLADA_ELEMENT_GLES_TEXCOMBINER_ARGUMENTALPHA_TYPE = "gles_texcombiner_argumentAlpha_type";
DLLSPEC daeString COLLADA_ELEMENT_GLES_TEXCOMBINER_COMMANDRGB_TYPE = "gles_texcombiner_commandRGB_type";
DLLSPEC daeString COLLADA_ELEMENT_GLES_TEXCOMBINER_COMMANDALPHA_TYPE = "gles_texcombiner_commandAlpha_type";
DLLSPEC daeString COLLADA_ELEMENT_GLES_TEXCOMBINER_COMMAND_TYPE = "gles_texcombiner_command_type";
DLLSPEC daeString COLLADA_ELEMENT_GLES_TEXTURE_PIPELINE = "gles_texture_pipeline";
DLLSPEC daeString COLLADA_ELEMENT_GLES_TEXTURE_UNIT = "gles_texture_unit";
...
DLLSPEC daeString COLLADA_ELEMENT_GLES_SAMPLER_STATE = "gles_sampler_state";
DLLSPEC daeString COLLADA_ELEMENT_GLES_NEWPARAM = "gles_newparam";
...
DLLSPEC daeString COLLADA_ELEMENT_ELLIPSOID = "ellipsoid";
