...
{
	domPerspectiveRef ref = new(bytes) domPerspective;
	return ref;
}


daeMetaElement *
domPerspective::registerElement()
{
	...
	//	Add attribute: _value
 	{
		...
		ma->setOffset( daeOffsetOf( domPerspective , _value ));
	...
	_Meta->setElementSize(sizeof(domPerspective));
	_Meta->validate();
...
daeMetaElement * domPerspective::_Meta = NULL;
