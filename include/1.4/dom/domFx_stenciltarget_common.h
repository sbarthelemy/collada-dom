...
class DLL_EXPORT domFx_stenciltarget_common_complexType 
{
 ...
 */
class DLL_EXPORT domFx_stenciltarget_common : public daeElement, public domFx_stenciltarget_common_complexType
{
