 ...
 */
class DLL_EXPORT domFx_sampler3D_common_complexType 
{
public:
	class domSource;
 ...
 */
class DLL_EXPORT domFx_sampler3D_common : public daeElement, public domFx_sampler3D_common_complexType
{
protected:
	/**
	 * Constructor
