...
class DLL_EXPORT domFx_cleardepth_common_complexType 
{
protected:  // Attribute
 ...
 */
class DLL_EXPORT domFx_cleardepth_common : public daeElement, public domFx_cleardepth_common_complexType
{
