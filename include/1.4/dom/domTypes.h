...
enum domMorphMethodType {
	MORPHMETHODTYPE_NORMALIZED = 1,
	MORPHMETHODTYPE_RELATIVE,
	MORPHMETHODTYPE_COUNT = 3
};
...
enum domFx_surface_type_enum {
	FX_SURFACE_TYPE_ENUM_UNTYPED = 1,
	...
	FX_SURFACE_TYPE_ENUM_COUNT = 8
};

enum domFx_surface_face_enum {
	FX_SURFACE_FACE_ENUM_POSITIVE_X = 1,
...
enum domFx_sampler_filter_common {
	...
	FX_SAMPLER_FILTER_COMMON_COUNT = 8
};

enum domFx_modifier_enum_common {
	FX_MODIFIER_ENUM_COMMON_CONST = 1,
...
enum domGlsl_pipeline_stage {
	GLSL_PIPELINE_STAGE_VERTEXPROGRAM = 1,
	GLSL_PIPELINE_STAGE_FRAGMENTPROGRAM,
	GLSL_PIPELINE_STAGE_COUNT = 3
};

enum domCg_pipeline_stage {
	CG_PIPELINE_STAGE_VERTEX = 1,
	CG_PIPELINE_STAGE_FRAGMENT,
	CG_PIPELINE_STAGE_COUNT = 3
};
