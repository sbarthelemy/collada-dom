...
class DLL_EXPORT domCg_sampler1D_complexType : public domFx_sampler1D_common_complexType
{
 ...
 */
class DLL_EXPORT domCg_sampler1D : public daeElement, public domCg_sampler1D_complexType
{
protected:
	/**
	 * Constructor
