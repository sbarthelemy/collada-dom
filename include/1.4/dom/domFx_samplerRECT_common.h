 ...
 */
class DLL_EXPORT domFx_samplerRECT_common_complexType 
{
public:
	class domSource;
 ...
 */
class DLL_EXPORT domFx_samplerRECT_common : public daeElement, public domFx_samplerRECT_common_complexType
{
protected:
	/**
	 * Constructor
