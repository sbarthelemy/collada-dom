...
class DLL_EXPORT domFx_colortarget_common_complexType 
{
 ...
 */
class DLL_EXPORT domFx_colortarget_common : public daeElement, public domFx_colortarget_common_complexType
{
