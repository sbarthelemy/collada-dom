 ...
 */
class DLL_EXPORT domGl_samplerRECT_complexType : public domFx_samplerRECT_common_complexType
{
 ...
 */
class DLL_EXPORT domGl_samplerRECT : public daeElement, public domGl_samplerRECT_complexType
{
protected:
	/**
	 * Constructor
